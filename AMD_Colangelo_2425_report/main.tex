...
\begin{itemize}
    ...
    contains information for approximately 200,000 books. 
...
\end{enumerate}
In the work done, the number H of independent hash functions choosen is 128, which has been resulted as a good compromise between the accuracy of the Jaccard similarity and the computational cost required. Every hash function is in the form of
\begin{equation}
...
For the work done it has been decided a minimum similarity threshold equal to about 0.4: since n = 128, to obtain $t \approx 0.4$ the choice of r has been 4 while the choice of b has been 32. 
...
\begin{figure}[H]
    ...
    \label{fig:placeholder}
\end{figure}
shows the graph for the function $p(s)$. The red dot is approximately 0.4 and is the minimum similarity threshold.
